...
export const metadata: Metadata = {
  title:       'Pricing',
  description: 'Three plans for every stage: Nukipa Free, Pro Managed and Partner. No subscription, no credit card. Just start.',
  alternates: {
...
const plans: Plan[] = [
  {
    ...
    price: '€0',
    cadence: 'forever',
    pitch: 'Start without risk. No subscription, no credit card.',
    cta:   { label: 'Get started free', href: SIGNUP_HREF, emphasis: 'primary' },
    features: [
      '1 campaign',
      '10 articles per month',
      '15 social posts per month',
      '25 prompt tests per week',
      '2 languages',
      'Hosting on a .nukipa.io subdomain'
    ]
  },
  {
    name:  'Nukipa Pro - Managed',
    price: 'Custom',
    pitch: 'Higher limits, a dedicated contact, tailored onboarding.',
    cta:   { label: 'Talk to sales', href: SALES_HREF, emphasis: 'primary' },
    features: [
      'Higher limits for articles, posts and prompt tests',
      'Dedicated contact',
      'Tailored onboarding',
      'SLA and priority support',
      'Integration with existing CMS on request'
    ],
    emphasized: true
  },
  {
    ...
    price: 'from €149',
    cadence: 'per month',
    pitch: 'White-label for agencies. Scale content delivery without adding headcount.',
    cta:   { label: 'Become a partner', href: SALES_HREF, emphasis: 'outline' },
    features: [
      '€149 per month base fee',
      '+ €390 per active customer workspace',
      'Custom branding across all client output',
      'Central management for multiple tenants',
      'Full API access'
    ]
  }
];
...
export default function PricingPage() {
  return (
    <>
      <Navbar locale="en" currentPath="/en/pricing" />
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
          <header className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-[18px] leading-[1.6] text-[color:var(--text-secondary)]">
              No subscription, no credit card. Just start. If Nukipa is not helping, it costs you nothing.
            </p>
          </header>
          ...
          <p className="mx-auto mt-14 max-w-2xl text-center text-[14px] text-[color:var(--text-muted)]">
            All prices in Euro, plus statutory VAT where applicable. Plans and limits may evolve. For the fine print see the <Link href="/en/legal/terms" className="text-[color:var(--brand-primary)] hover:underline">Terms</Link>.
          </p>
        </section>
      </main>
      <Footer locale="en" currentPath="/en/pricing" />
    </>
  );
}
